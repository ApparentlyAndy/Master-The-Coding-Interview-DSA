...
func (node *Node) DFSInorder() (values []int) {
	currentNode := node
	if currentNode.left != nil {
		values = append(values, currentNode.left.DFSInorder()...)
	}
	values = append(values, currentNode.value)
	if currentNode.right != nil {
		values = append(values, currentNode.right.DFSInorder()...)
	}
	return
}

func (node *Node) DFSPreorder() (values []int) {
	currentNode := node
	values = append(values, currentNode.value)
	if currentNode.left != nil {
		values = append(values, currentNode.left.DFSPreorder()...)
	}
	if currentNode.right != nil {
		values = append(values, currentNode.right.DFSPreorder()...)
	}
	return
}

func (node *Node) DFSPostorder() (values []int) {
	currentNode := node
	if currentNode.left != nil {
		values = append(values, currentNode.left.DFSPostorder()...)
	}
	if currentNode.right != nil {
		values = append(values, currentNode.right.DFSPostorder()...)
	}
	values = append(values, currentNode.value)
	return
}
